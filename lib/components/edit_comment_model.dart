...
class EditCommentModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (editcomment)] action in Button widget.
  ApiCallResponse? commentEditRes;
